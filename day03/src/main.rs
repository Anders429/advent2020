...
fn main() {
    ...
    println!("{}", solve(&input, 1, 1) * solve(&input, 3, 1) * solve(&input, 5, 1) * solve(&input, 7, 1) * solve(&input, 1, 2));
}
...
mod tests {
    ...
    fn test_hard() {
        ...
        assert_eq!(solve(input, 1, 1) * solve(input, 3, 1) * solve(input, 5, 1) * solve(input, 7, 1) * solve(input, 1, 2), 336)
    }
}
